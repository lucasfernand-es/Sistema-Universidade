...
public class FormTemplate extends javax.swing.JFrame {
    ...
    protected ValueObject selectedData = null;
    
    
    protected ValueObject inputData = null;
    ...
    protected JTable getjTBBuscaRapida() {
        return jTBSearch;
    }
    ...
    private void initComponents() {
        ...
        jTBSearch = new javax.swing.JTable();
        ...
        jTBSearch.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jPBuscarLayout.setHorizontalGroup(
            ...
            .addGroup(jPBuscarLayout.createSequentialGroup()
                ...
                .addGroup(jPBuscarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jSPTable, javax.swing.GroupLayout.DEFAULT_SIZE, 892, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    protected void jBTCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBTCadastrarActionPerformed
        ...
        //System.out.println("passou 1 vez?");
    ...
    protected void jBTSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBTSalvarActionPerformed
        ...
        {
            this.captureScreenData();
            this.inputData.setId( this.selectedData.getId() );
        }
        catch(Exception ex)
        {
            ViewHelper.errorMessage(ex.getMessage());
    ...
    }//GEN-LAST:event_jTBSearchMouseClicked
